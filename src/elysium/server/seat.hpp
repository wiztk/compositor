...
#ifndef ELYSIUM_SERVER_SEAT_HPP_
#define ELYSIUM_SERVER_SEAT_HPP_
...
class Seat : public AbstractGlobal {
 ...
 private:
  ...
  static void Release(struct wl_client *client,
                      struct wl_resource *resource);

  static struct wl_seat_interface kInterface;
};

}
}

#endif //ELYSIUM_SEAT_HPP
